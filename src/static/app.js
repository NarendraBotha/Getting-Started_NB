                ...
                ${details.participants.map(email => `
                  <li class="participant-item">
                    ...
                    <button class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${email}">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#e53935" viewBox="0 0 24 24"><path d="M3 6h18v2H3V6zm2 3h14l-1.5 14h-11L5 9zm5 2v8h2v-8h-2zm-4 0v8h2v-8H6zm8 0v8h2v-8h-2z"/></svg>
                    </button>
                  </li>
                `).join("")}
              </ul>
